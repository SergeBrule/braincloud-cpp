...
namespace BrainCloud
{
    ...
    void BrainCloudRelay::connect(eRelayConnectionType in_connectionType, const RelayConnectOptions& in_options, IRelayConnectCallback* in_callback)
    {
        m_commsLayer->connect(in_connectionType, in_options, in_callback);
    }
